...
INVERSION_LOG_PATH = os.path.join(MANIFEST_ROOT, "log_inversion.txt") # [NEW] Path log inversion
...
if manifest_rows:
    ...
    # Summary Log
    n_inverted = sum(1 for row in manifest_rows if row["inverted"])
